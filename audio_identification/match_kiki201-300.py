...
arr = np.load("./last_result/kiki/kiki_list201-300.npz",allow_pickle=1)
b300 = arr['arr_0']
arr1 = np.load("./last_result/kiki/kiki_list201-300_ref.npz",allow_pickle=1)
b300id = arr1['arr_0']
...
for ii in range(1,7):
    ...
    print(offset)
    np.savez_compressed('./last_match/kikicounter201-300'+f"Q{ii}", track_most_common_offset_counter)