...
arr = np.load("./last_result/bouba/bouba400.npz",allow_pickle=1)
b400 = arr['arr_0']
arr1 = np.load("./last_result/bouba/bouba_ref400.npz",allow_pickle=1)
b400id = arr1['arr_0']

arr = np.load("./last_result/bouba/bouba500.npz",allow_pickle=1)
b500 = arr['arr_0']
arr1 = np.load("./last_result/bouba/bouba_ref500.npz",allow_pickle=1)
b500id = arr1['arr_0']

IL = np.concatenate((b400,b500))
IL_id = np.concatenate((b400id,b500id))
